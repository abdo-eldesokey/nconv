...
class CNN(nn.Module):
    ...
    def __init__(self, pos_fn=None):
        ...
        sys.path.append('workspace/exp_guided_nconv_cnn_l2/unguided_network_pretrained')
        f = importlib.import_module('unguided_network')
        self.d_net = f.CNN()
        checkpoint_dict = torch.load('workspace/exp_guided_nconv_cnn_l2/unguided_network_pretrained/CNN_ep0005.pth.tar')
